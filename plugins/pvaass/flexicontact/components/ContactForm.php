...
namespace pvaass\FlexiContact\components;


use Cms\Classes\ComponentBase;
use pvaass\FlexiContact\Models\Settings;
use Mail;
use Validator;
...
class ContactForm extends ComponentBase{
     ...
     *     if (get_class($handler) !== 'pvaass\FlexiContact\components\ContactForm') return;
    ...
    {
        return [
            'name' => 'pvaass.flexicontact::lang.strings.component_name',
            'description' => 'pvaass.flexicontact::lang.strings.component_desc'
        ];
    }
    ...
    public function defineProperties(){
        ...
        return [
            'injectBootstrapAssets' => [
                'title'       => 'pvaass.flexicontact::lang.strings.inject_bootstrap',
                'description' => 'pvaass.flexicontact::lang.strings.inject_bootstrap_desc',
                'type'        => 'checkbox',
                'default'     => true,
            ],
            'injectMainScript' => [
                'title'       => 'pvaass.flexicontact::lang.strings.inject_main_script',
                'description' => 'pvaass.flexicontact::lang.strings.inject_main_script_desc',
                'type'        => 'checkbox',
                'default'     => true,
            ]
        ];
    ...
    public function onMailSent()
    {
        ...
        Mail::send('pvaass.flexicontact::emails.message', post(), function($message)
        {
